...
def process_calendar(command)
  ...
  if client.authorization.client_id.nil? && File.file?('client_secrets.json')
  ...
  if File.file?('client_authorization.json') && client.authorization.access_token.nil?
    File.open('client_authorization.json', 'r') do |file|
  ...
  elsif !File.file?('client_authorization.json') && client.authorization.access_token.nil?
    ...
    open('client_authorization.json', 'w+') { |f| f.write(client.authorization.to_json) }
  end
